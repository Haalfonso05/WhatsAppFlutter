                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            child: const Icon(Icons.login_rounded, color: Color(0xFF818CF8), size: 26),
                          ),
                          ...
                          SizedBox(
                            ...
                            child: FilledButton(
                              ...
                              child: _loading
                                  ...
                                  : const Text('Iniciar sesion', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600)),
                            ),
                          ),
                          const SizedBox(height: 20),
                          Row(
                            ...
                            children: [
                              const Text('No tienes cuenta?  ', style: TextStyle(fontSize: 13, color: Color(0xFF64748B))),
                              GestureDetector(
